  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-cyan-500 selection:text-black overflow-x-hidden">
          ...
          return (
            <div className={containerClass}>
              {count > 0 ? (
                  ...
                  return (
                    <div key={member._id} className={itemClass}>
                      <div className="relative w-48 h-48 mx-auto mb-6 rounded-full p-1 bg-gradient-to-br from-zinc-700 to-black group-hover:from-cyan-500 group-hover:to-blue-600 transition-all duration-500">
                        <img src={member.img} alt={member.name} className="w-full h-full object-cover rounded-full border-4 border-black grayscale group-hover:grayscale-0 transition-all duration-500" />
                      </div>
                ...
                <div className="col-span-3 text-zinc-500 italic">Loading team members...</div>
              )}
            </div>
          );
        })()}
      ...
      <section className="py-20 bg-gradient-to-r from-black via-zinc-900 to-black border-t border-zinc-900 text-center relative z-10">
        ...
        <p className="text-zinc-400 mb-10 max-w-xl mx-auto">The car of your dreams is waiting in our garage. Don't just watch the road—dominate it.</p>
        <Link to="/customers" className="inline-block px-10 py-4 bg-white text-black font-bold text-sm tracking-[0.2em] hover:bg-cyan-400 transition-colors duration-300 uppercase skew-x-[-10deg]">
